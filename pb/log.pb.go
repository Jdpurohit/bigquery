...
func (x *LogsTable) GetConfigId() string {
	if x != nil {
		return x.ConfigId
	}
	return ""
...
func (x *LogsBDTable) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
var file_log_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6e,
